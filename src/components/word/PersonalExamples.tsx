  ...
  return (
    <section>
      <div className="mb-2 flex items-center gap-2 text-sm font-bold uppercase tracking-wide text-sky-600">
        <PenLine className="h-4 w-4" /> Your example
      </div>
      <p className="mb-2 text-xs text-muted-foreground">
        Write a sentence using <span className="font-semibold">{term}</span> tied to your own experience — the more
        personal, the easier to remember.
      </p>
